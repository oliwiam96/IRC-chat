...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_close = new QPushButton(tab_connect);
        pushButton_close->setObjectName(QStringLiteral("pushButton_close"));
        pushButton_close->setGeometry(QRect(520, 330, 91, 29));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_close->setText(QApplication::translate("MainWindow", "Reset servera", 0));
